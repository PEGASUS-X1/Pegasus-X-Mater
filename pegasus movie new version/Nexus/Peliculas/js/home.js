...
let noticias = [
  {
    ...
    "imagen": "https://pegasus-v2.tk/PGX.PNG",
...
function createSlide(noticia) {
  ...
  btn.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"> <path d="M8 5v14l11-7z"></path></svg>';
  btn.className = 'play';
...
var notificationConfigs = [
  {
    tituloNoti: "<i class='bx bx-station bx-flashing '></i> ESTRENO",
    resumen: "Five Nights at Freddy's",
    buttonText: "x",
    modalabri: "modal-1",
    iframeUrl: "",
    imageUrl: "https://nintenduo.com/wp-content/uploads/2023/05/Poster-FNAF-Pelicula-01.webp",
    verUrl: "#",
